...
<html>
    ...
    <body>
        ...
        var subCategorias = $municipios;
        console.log(subCategorias);
        console.log(subCategorias[0]);
        console.log(subCategorias[0]['regiao-imediata']['regiao-intermediaria']['UF']['id']);
        var IdCategoria = subCategorias[0]['regiao-imediata']['regiao-intermediaria']['UF']['id'];
        ...
        var x = ['regiao-imediata']['regiao-intermediaria']['UF']['id'];
        console.log(x);
        function carregaCombo2(categoria) {
            ...
            var subCategoriasFiltradas = $.grep(subCategorias, function (e) { return e.x == categoria; });
